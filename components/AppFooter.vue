	...
	<footer class="flex md:justify-between border-top text-menu-text font-fira_retina">
		<div class="w-full flex justify-between md:justify-start">
			...
			<div id="social-icons" class="flex">
				<NuxtLink
					:to="t('contacts.social.twitter.url') + t('contacts.social.twitter.user')"
					target="_blank"
				...
				<NuxtLink
					:to="t('contacts.social.facebook.url') + t('contacts.social.facebook.user')"
					target="_blank"
					class="flex justify-center items-center"
				>
				...
				<NuxtLink
					:to="t('contacts.social.github.url') + t('contacts.social.github.user')"
					target="_blank"
